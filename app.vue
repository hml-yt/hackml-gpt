  ...
  <div class="absolute inset-0">
    <main class="relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1">
      <div class="flex-1 overflow-hidden">
        <div class="react-scroll-to-bottom--css-kfvql-79elbk h-full dark:bg-gray-800">
          <div class="react-scroll-to-bottom--css-kfvql-1n7m0yu">
              ...
              <div
                ...
                <div
                  ...
                  <div class="w-[30px] flex flex-col relative items-end">
                    <div class="relative flex bg-indigo-500">
                      <Icon name="uil:user" size="large" />
                    </div>
                  </div>
                  <div class="relative flex w-[calc(100%-50px)] md:flex-col lg:w-[calc(100%-115px)]">
                    <div class="flex flex-grow flex-col gap-3">
                      <div class="min-h-[20px] flex flex-col items-start gap-4 whitespace-pre-wrap">hello</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div
          ...
          <div class="relative flex h-full flex-1 md:flex-col">
            ...
            <div
              ...
              <textarea tabindex="0" data-id="request-:r0:-0" rows="1" placeholder="Write your message here..."
                @keypress.enter.exact.prevent="submitMessage" :disabled="loading"
                ...
                @click.prevent="submitMessage" :disabled="loading"
        ...
        <div class="px-3 pt-2 pb-3 text-center text-xs text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-6"><a
            href="https://beta.openai.com" target="_blank" rel="noreferrer" class="underline">This is a ChatGPT clone.
            Go check out the real deal.</a></div>
      </div>
    </main>
  </div>
</template>
