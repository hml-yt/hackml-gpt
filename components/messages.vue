                ...
                <div class="flex flex-col items-center text-sm h-full chat-messages">
                    <div class="gap-4 mx-auto p-5 m-5 py-1 text-gray-800">
                        ...
                        <p class="mt-2 md:max-w-2xl lg:max-w-2xl xl:max-w-3xl  text-sm text-gray-500">
                            ...
                            have any questions or comments, <a class="underline text-indigo-300"
                                href="https://discord.gg/fyA9tCc7K4" target="_blank">contact me on Discord</a>. And
                        ...
                        <div
                            ...
                            <div class="relative flex w-[calc(100%-50px)] md:flex-col lg:w-[calc(100%-115px)]" v-else>
                                <textarea autofocus
                                    ...
                                    @keypress.enter.exact.prevent="updateMessage(index, $event)"
...
const getJson = () => {
    return JSON.stringify(messages.value.slice(1));
}
